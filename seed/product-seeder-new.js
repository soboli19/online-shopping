...
var products = [
    ...
    new Product({
     imagePath: "../images/P3.Polish-Harvest.jpg",
     title: 'Полиры для циркония Harvest',
     description: 'YellowStone P3 алмазный абразив для обр циркония,дисиликата лития, керамики 1шт',
     storedisplay: false,
     price: [48],
     size: [],
     color: [],
    ...
    new Product({
        imagePath: '../images/BQ-ZircDisk.png',
        title: 'Полиры для циркония Harvest',
        description: 'Абразивные зеленые камни с добавкой алмазной крошки  BestQual',
        fulldescr: 'Абразивные зеленые камни с добавкой алмазной крошки  BestQual',
        storedisplay: false,
        price: [15],
        size: [],
        color: [],
